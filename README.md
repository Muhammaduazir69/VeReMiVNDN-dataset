...
for i in 00 01 02 03 04 05 06 07; do
  curl -LO https://github.com/Muhammaduazir69/VeReMiVNDN-dataset/releases/download/v1.0.0/veremivndn_ml.tar.gz.part$i
done
...
```bash
curl -LO https://github.com/Muhammaduazir69/VeReMiVNDN-dataset/releases/download/v1.0.0/veremivndn_plane.tar.gz
```
...
```bash
curl -LO https://github.com/Muhammaduazir69/VeReMiVNDN-dataset/releases/download/v1.0.0/CHECKSUMS.sha256
